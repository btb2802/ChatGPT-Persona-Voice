...
| Live relay evidence | Manually accepted live | User-mode build/contract proof; awaiting v0.1.3 physical-host reports | Ubuntu 24.04 / WirePlumber 0.4 and Fedora 42 / PipeWire 1.4.11 / WirePlumber 0.5.14 accepted live |
...
The `v0.1.3` tag workflow builds target-native DMG/ZIP, NSIS, and AppImage artifacts and signs a
